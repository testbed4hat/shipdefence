...
class InlineResponse20015(object):
    ...
    @property
    def path(self):
        """Gets the path of this InlineResponse20015.  # noqa: E501


        :return: The path of this InlineResponse20015.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this InlineResponse20015.


        :param path: The path of this InlineResponse20015.  # noqa: E501
        :type: str
        """
